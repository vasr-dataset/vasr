...
distractors_cache_path = os.path.join(analogies_output_path, 'data', 'aggregate', f"distractors_cache_{SPLIT}.pickle")
aggregate_dir = os.path.join(analogies_output_path, 'data', 'aggregate')
...
data_path = os.path.join(analogies_output_path, 'data')
plots_path = os.path.join(analogies_output_path, 'plots')
...
for d in [analogies_output_path, swig_path, data_path, aggregate_dir, distractors_split_path, random_split_path, AB_matches_dir, ABCD_matches_dir, plots_path, ab_matches_plots_dir, abcd_matches_plots_dir, ab_matches_plots_path, analogies_plots_path, analogies_distractors_plots_path, test_plots_path]:
